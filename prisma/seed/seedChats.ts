          ...
          data: [
            {
              ...
              message: "Message from user to band 1",
              isRead: true,
            },
            {
          ...
          data: [
            {
              ...
              message: "Message from user to band 2",
              isRead: true,
            },
            {
          ...
          data: [
            {
              ...
              message: "Message from user to band 3",
              isRead: true,
            },
            {
