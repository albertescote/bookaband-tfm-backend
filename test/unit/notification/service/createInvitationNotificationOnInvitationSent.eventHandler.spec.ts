...
import { CreateInvitationNotificationOnInvitationSentEventHandler } from "../../../../src/context/notification/service/createInvitationNotificationOnInvitationSent.eventHandler";
...
describe("CreateInvitationNotificationOnInvitationSentEventHandler", () => {
  let handler: CreateInvitationNotificationOnInvitationSentEventHandler;
  ...
  const mockEvent = new InvitationSentEvent(
    bandId,
    userId,
    "John Doe",
    new Date(),
  ...
  beforeEach(async () => {
    ...
    handler =
      module.get<CreateInvitationNotificationOnInvitationSentEventHandler>(
        CreateInvitationNotificationOnInvitationSentEventHandler,
      );
  });
