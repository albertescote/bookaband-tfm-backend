...
import { CreateBookingNotificationOnBandSignedEventHandler } from "../../../../src/context/notification/service/createBookingNotificationOnBandSigned.eventHandler";
...
describe("CreateBookingNotificationOnBandSignedEventHandler", () => {
  let handler: CreateBookingNotificationOnBandSignedEventHandler;
  ...
  const mockEvent = new BandSignedContractEvent(
    bookingId,
    "John Doe",
    "Test Band",
    "Test Event",
  ...
  beforeEach(async () => {
    ...
    handler = module.get<CreateBookingNotificationOnBandSignedEventHandler>(
      CreateBookingNotificationOnBandSignedEventHandler,
    );
  });

  describe("handle", () => {
    it("should create a notification when band signs contract", async () => {
      const mockBooking = {
        id: bookingId,
