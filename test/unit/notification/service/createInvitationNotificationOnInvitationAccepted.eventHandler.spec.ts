...
import { CreateInvitationNotificationOnInvitationAcceptedEventHandler } from "../../../../src/context/notification/service/createInvitationNotificationOnInvitationAccepted.eventHandler";
...
describe("CreateInvitationNotificationOnInvitationAcceptedEventHandler", () => {
  let handler: CreateInvitationNotificationOnInvitationAcceptedEventHandler;
  ...
  const mockEvent = new InvitationAcceptedEvent(bandId, userId, "John Doe");
  ...
  beforeEach(async () => {
    ...
    handler =
      module.get<CreateInvitationNotificationOnInvitationAcceptedEventHandler>(
        CreateInvitationNotificationOnInvitationAcceptedEventHandler,
      );
  });
